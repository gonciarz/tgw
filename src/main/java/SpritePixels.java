...
public class SpritePixels
{
   ...
   /*
    * Inner pixels Color or null if this Sprite is incapable of changing.
    */
   ...
   /*
    * pixel array for a Sprite's current Image - if it's visible. It
   ...
   {
      //System.out.print("SpritePixels.fillXUnitLine: x0="+x0+", y0="+y0);
   ...
   {
      //System.out.print("SpritePixels.fillYUnitLine: x0="+x0+", y0="+y0);
      //System.out.println(", x1="+x1+", y1="+y1);
      boolean negSlope = false;
      int dX = x1 - x0;
      int x = x0;
   ...
   {
      //System.out.print("SpritePixels.setLinePixels: x0="+x0+", y0="+y0);
      //System.out.println(", x1="+x1+", y1="+y1);
      if ( x0 == x1 )
         if ( y0 <= y1 )
