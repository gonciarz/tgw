...
/**
 * pl.gpost.operation.TGSetPixelsOp provides TurtleGraphics with a SETPIXELS graphics operation.
 * <p/>
 * pl.gpost.operation.TGSetPixelsOp should be thought of as a BitBlt, a block transfer of pixels
...
public class TGSetPixelsOp implements ImageObserver, TGGraphicsOp {
    ...
    private static final String CLASS_NAME = "pl.gpost.operation.TGSetPixelsOp";
     ...
     * @param topLeft Left-most x, top-most y, coordinates of rectangle of
     *                pixels to be replaced - destination.
     * @param pixRect pl.gpost.PixelRectangle which includes an array of the pixels
    ...
    //
    // pl.gpost.operation.TGGraphicsOp Interface Methods
    //
    ...
    public Rectangle doIt(Image inMemoryImage) {
        ...
        if (destImgHeight == -1)
            return null;
        // convert pl.gpost.TGPoint prTopLeft from TurtleSpace to x,y coordinates
...
} // end class pl.gpost.operation.TGSetPixelsOp
