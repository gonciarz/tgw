...
import pl.gpost.TGPoint;

import java.awt.*;
import java.awt.image.ImageObserver;

/**
 * pl.gpost.operation.TGLineOp provides a TurtleGraphics Line graphics Operation.
 * A line of a specified penWidth is drawn between two TurtleSpace
 * points.
 * <p>
 * *NOTE* The points supplied to a pl.gpost.operation.TGLineOp constructor are arranged
...
public class TGLineOp implements ImageObserver, TGGraphicsOp
{
   ...
   /**
    * Return a pl.gpost.operation.TGLineOp, a line drawing operation given its end points, its
   ...
   {
      System.err.println( "pl.gpost.operation.TGLineOp.imageUpdate: got here!" );
      return true;
   }
   ...
   {
      //System.out.println( "pl.gpost.operation.TGLineOp.drawHorizontalFatLine()" );
   ...
   {
      //System.out.println( "pl.gpost.operation.TGLineOp.drawFatLine()" );
   ...
   {
      //System.out.println( "pl.gpost.operation.TGLineOp.drawOnePixelFatLine()" );
      // compute the width end points of perpendicular line at p1
      double hafWid = ((double) penWidth) / 2.0;
      double perpLineHead = heading + QTR_CIRCLE_RADIANS;
      if ( perpLineHead > CIRCLE_RADIANS )
   ...
   {
      //System.out.println( "pl.gpost.operation.TGLineOp.drawVerticalFatLine()" );
      double hafWid =  ((double)penWidth) / 2.0;
   ...
   /**
    * Draw the line defined by this pl.gpost.operation.TGLineOp object.
    */
   ...
   {
      return "pl.gpost.operation.TGLineOp[color="+color+",width="+penWidth+",p1="+p1+",p2="+p2+"]";
   }

} // end class pl.gpost.operation.TGLineOp
