 ...
 * a Component.  In pl.gpost.TGCanvas' case, the pixels displayed are in an
...
public class TGFillOp implements ImageObserver, TGGraphicsOp {
    ...
    private static final String CLASS_NAME = "pl.gpost.operation.TGFillOp";
    ...
    //
    // Implementation of pl.gpost.operation.TGGraphicsOp Interface
    //
    ...
    public Rectangle doIt(Image graphicsImage) {
        ...
        if (sourceHeight == -1)
            return null;
        // convert pl.gpost.TGPoint origin of the FILL operation to the x,y
    ...
    public synchronized boolean imageUpdate(Image img, int flags, int x, int y, int wd, int ht) {
        //System.out.print("pl.gpost.operation.TGFillOp.imageUpdate: flags=" );
...
} // end class pl.gpost.operation.TGFillOp
