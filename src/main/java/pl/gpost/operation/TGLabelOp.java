...
public class TGLabelOp implements ImageObserver, TGGraphicsOp
{
   ...
   public Rectangle doIt( Image inMemoryImage )
   {
      ...
      //System.out.print("pl.gpost.operation.TGLabelOp: using " + font.getSize() + "pt font,");
   ...
   {
      System.out.println( "pl.gpost.operation.TGLabelOp.imageUpdate: got here!" );
      return true;
   }

} // end class pl.gpost.operation.TGLabelOp
