...
import pl.gpost.PixelRectangle;

import java.awt.Color;

/**
 * pl.gpost.sprite.SpritePixels is an abstract class that another class extends when
 * it wants to provide the pixels that make up the image of a pl.gpost.Sprite.
 * <p/>
 *
 * @author Guy Haas
 */
...
public class SpritePixels {
     ...
     */
    public static final String CLASS_NAME = "pl.gpost.sprite.SpritePixels";
    ...
    /*
     * Inner pixels Color or null if this pl.gpost.Sprite is incapable of changing.
     */
    ...
    /*
     * pixel array for a pl.gpost.Sprite's current Image - if it's visible. It
    ...
    /**
     * Instantiate the pixels that make up a pl.gpost.Sprite's Image given an
     * array of pixels.  The assumed orientation of the pl.gpost.PixelRectangle
    ...
    /**
     * Instantiate a pl.gpost.Sprite's Image given its dimensions, color, and
    ...
    private void fillXUnitLine(int x0, int y0, int x1, int y1, int value) {
        //System.out.print("pl.gpost.sprite.SpritePixels.fillXUnitLine: x0="+x0+", y0="+y0);
    ...
    private void fillYUnitLine(int x0, int y0, int x1, int y1, int value) {
        //System.out.print("pl.gpost.sprite.SpritePixels.fillYUnitLine: x0="+x0+", y0="+y0);
        //System.out.println(", x1="+x1+", y1="+y1);
        boolean negSlope = false;
        int dX = x1 - x0;
        int x = x0;
    ...
    /*
     * Set white pixels outside the perimeter of the pl.gpost.Sprite's image to be transparent.
     */
    ...
    /**
     * Return the default minimum height of this pl.gpost.Sprite's image.
    ...
    /**
     * Return the default minimum width of this pl.gpost.Sprite's image.
     * Subclasses should override this method if they support a
     ...
     * by the child subclass. A pl.gpost.sprite.SpritePixels constructor invokes this method.
     */
    ...
    protected void setLinePixels(int x0, int y0, int x1, int y1, int rgbVal) {
        //System.out.print("pl.gpost.sprite.SpritePixels.setLinePixels: x0="+x0+", y0="+y0);
        //System.out.println(", x1="+x1+", y1="+y1);
        if (x0 == x1)
            if (y0 <= y1)
    ...
    /**
     * Fill the specified (x,y) pixel in the pl.gpost.Sprite's image with
    ...
    protected void setPixel(int x, int y, int rgbVal) {
        String me = "pl.gpost.sprite.SpritePixels.setPixel: ";
    ...
    /**
     * Return a copy of this pl.gpost.Sprite's pixels.
     */
    ...
    /**
     * Return the length of a side of this pl.gpost.Sprite's square
     * array of pixels.
     */
    ...
    /**
     * Return the current height of this pl.gpost.Sprite's image. This
    ...
    /**
     * Return the current width of this pl.gpost.Sprite's image. This
     * includes taking into account the current heading.
     */
    public int getWidth() {
        if (spritePixels == null)
...
} // end class pl.gpost.sprite.SpritePixels
