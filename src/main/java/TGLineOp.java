...
public class TGLineOp implements ImageObserver, TGGraphicsOp
{
   ...
   /**
    * Return a TGLineOp, a line drawing operation given its end points, its
   ...
   {
      //System.out.println( "TGLineOp.drawHorizontalFatLine()" );
   ...
   {
      //System.out.println( "TGLineOp.drawFatLine()" );
   ...
   {
      //System.out.println( "TGLineOp.drawOnePixelFatLine()" );
      // compute the width end points of perpendicular line at p1
      double hafWid = ((double) penWidth) / 2.0;
      double perpLineHead = heading + QTR_CIRCLE_RADIANS;
      if ( perpLineHead > CIRCLE_RADIANS )
   ...
   {
      //System.out.println( "TGLineOp.drawVerticalFatLine()" );
      double hafWid =  ((double)penWidth) / 2.0;
